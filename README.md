# UI for basic cryptocurrency implementation developed in Go.
I developed this project while self-studying the Go programming language.  
The backend and full description of the project can be found [here](https://github.com/Kabdenov/naivecoin-golang)
